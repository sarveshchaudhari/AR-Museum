    ...
    return (
        <div>
            <div style={{ paddingBottom: "190px" }}>
                <nav className="navbar navbar-expand-lg fixed-top navbar-light" style={{ backgroundColor: 'rgba(33, 150, 243, 0.8)', backdropFilter: 'blur(10px)', transition: '0.3s' }}>
                    <div className="container-fluid">
                        ...
                        <span className="navbar-brand d-flex align-items-center">
                            ...
                            />
                            <span style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#fff' }}>Web-AR Experience</span>
                        </span>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item">
                                    <Link className="nav-link" aria-current="page" to="/home" style={navLinkStyle}>Home</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" to="/book" style={navLinkStyle}>Schedule Booking</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" to="/viewbooking" style={navLinkStyle}>View Bookings</Link>
                                </li>
                                <li className="nav-item ms-3">
                                    <Link className="nav-link" to="/about" style={navLinkStyle}>About</Link>
                                </li>
                            </ul>
                            <ul className="navbar-nav ms-auto"> {/* Right-aligned Logout */}
                                <li className="nav-item">
                                    <Link className="nav-link d-flex align-items-center" to="/" onClick={() => { setAuthenticate({ status: false }) }} style={navLinkStyle}>
                                        <img
                                            src={logoutIcon}
                                            alt="Logout Icon"
