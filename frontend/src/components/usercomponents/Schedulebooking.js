...
export default function Schedulebooking() {
    ...
    return (
        <div style={{ paddingBottom: '20px' }}>
            {/* Alert */}
            {(alertmessage.bookingsuccess || alertmessage.bookingfailure) && <Alert message={message} />}
            
            {/* Main Content */}
            <div style={{ width: '100vw', minHeight: 'calc(100vh - 100px)', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px' }}>
                <div style={{ boxShadow: '0 4px 8px rgba(0,0,0,0.1)', borderRadius: '8px', backgroundColor: '#fff', width: '100%', maxWidth: '600px' }}>
